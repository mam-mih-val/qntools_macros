...
void VariableManager::InitVariables( ROOT::RDF::RInterface<ROOT::Detail::RDF::RJittedFilter, void>& filtered_data_frame ){
...
void VariableManager::ConfigureRDF( ROOT::RDF::RInterface<ROOT::Detail::RDF::RJittedFilter, void>& filtered_data_frame ){
...
void VariableManager::operator()( const ULong64_t event_id,
...
void VariableManager::PrintVCLayout(){
