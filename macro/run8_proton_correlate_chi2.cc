...
{
  {"proton_chi2_5_RESCALED", "F1_RESCALED"},
  {"proton_chi2_5_RESCALED", "F2_RESCALED"},
  {"proton_chi2_5_RESCALED", "F3_RESCALED"},
  
  {"proton_chi2_4_RESCALED", "F1_RESCALED"},
  {"proton_chi2_4_RESCALED", "F2_RESCALED"},
  {"proton_chi2_4_RESCALED", "F3_RESCALED"},
  
  {"proton_chi2_3_RESCALED", "F1_RESCALED"},
  {"proton_chi2_3_RESCALED", "F2_RESCALED"},
  {"proton_chi2_3_RESCALED", "F3_RESCALED"},
};
