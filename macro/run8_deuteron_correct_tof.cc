...
void run8_deuteron_correct_tof( std::string list, 
  ...
  auto f1_1000010020_m_400 = new TF1("1000010020_mean_400", "pol1");
	f1_1000010020_m_400->SetParameter(0, 3.68838);
	f1_1000010020_m_400->SetParameter(1, -0.0361821);

	auto f1_1000010020_s_400 = new TF1("1000010020_sigma_400", "pol2");
	f1_1000010020_s_400->SetParameter(0, 0.388772);
	f1_1000010020_s_400->SetParameter(1, -0.140837);
	f1_1000010020_s_400->SetParameter(2, 0.0282573);

	auto f1_1000010020_m_700 = new TF1("1000010020_mean_700", "pol1");
	f1_1000010020_m_700->SetParameter(0, 3.62803);
	f1_1000010020_m_700->SetParameter(1, 0.0142138);

	auto f1_1000010020_s_700 = new TF1("1000010020_sigma_700", "pol2");
	f1_1000010020_s_700->SetParameter(0, 0.24795);
	f1_1000010020_s_700->SetParameter(1, -0.0451928);
	f1_1000010020_s_700->SetParameter(2, 0.0153449);
  ...
  (double multiplicity){
      ...
      std::vector<int> multiplicity_edges{ 141, 89, 64, 46, 32, 22, 14, 8, 0 };
  ...
  const auto subevent_phi_generator = []( auto modules ) {
    return [modules]( ROOT::VecOps::RVec<float> pos_x, ROOT::VecOps::RVec<float> pos_y ){
      auto sum_x = float{0};
      auto sum_y = float{0};
      for( auto id : modules ){
        sum_x+=pos_x.at(id);
      ...
      auto x_c = sum_x / static_cast<float>( pos_x.size() );
  ...
  std::vector<int> physical_runs{ 8319 ,8320 ,8321 ,8322 ,8323 ,8324 ,8326 ,8329 ,8330 ,8331 ,8332 ,8334 ,8335 ,8338 ,8339 ,8343 ,8344 ,8375 ,8379 ,8380 ,8381 ,8382 ,8384 ,8386 ,8387 ,8388 ,8389 ,8390 ,8392 ,8393 ,8394 ,8395 ,8398 ,8399 ,8401 ,8402 ,8412 ,8413 ,8414 ,8415 ,8419 ,8420 ,8421 ,8422 ,8425 ,8426 ,8427 };
  ...
  auto dd=d
          ...
          .Define("fhcalModF1Phi", subevent_phi_generator(f1_modules), {"fhcalModX", "fhcalModY"} )
          .Define("fhcalModF2Phi", subevent_phi_generator(f2_modules), {"fhcalModX", "fhcalModY"} )
          .Define("fhcalModF3Phi", subevent_phi_generator(f3_modules), {"fhcalModX", "fhcalModY"} )
