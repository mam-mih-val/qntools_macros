...
void run8_proton_correlate_4part(string inputFiles="qn.root", string outputFile="corr.root")
{
  int nSamples = 100;
  ...
  for ( auto &corr: u1u1Q1Q1_rescaled )
  {
    ...
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1x1y1y1", P4::xxyy(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1y1x1y1", P4::xyxy(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1y1y1x1", P4::xyyx(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
    
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1x1x1y1", P4::yxxy(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1x1y1x1", P4::yxyx(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1y1x1x1", P4::yyxx(1, 1, 1, 1), wSumWu4part, wy, qn, qn);
