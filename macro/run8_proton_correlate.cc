...
vector <vector<string>> u1_rescaled_Q1_rescaled=
{
  ...
  {"proton_nhits8", "F1_RESCALED"},
  {"proton_nhits8", "F2_RESCALED"},
  {"proton_nhits8", "F3_RESCALED"},

  {"proton_nhits9", "F1_RESCALED"},
  {"proton_nhits9", "F2_RESCALED"},
  {"proton_nhits9", "F3_RESCALED"},
};
