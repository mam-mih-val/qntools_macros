...
void run8_proton_correct_vtx( std::string list, 
  ...
  correction_task.SetEventVariables(std::regex("centrality|vtxX|vtxY"));
  ...
  correction_task.AddEventAxis( {"vtxX", 2, -1, 1} );
  correction_task.AddEventAxis( {"vtxY", 2, -1, 1} );
