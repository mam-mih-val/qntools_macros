...
void run8_sim_correlations( std::string list, std::string str_effieciency_file ){
  ...
  DefineVector( sampled_d, "sim_F1", q_vector< std::vector<float>, std::vector<double> >(harmonics), std::vector<std::string>{"simPhi", "simF1w"} );
  DefineVector( sampled_d, "sim_F2", q_vector< std::vector<float>, std::vector<double> >(harmonics), std::vector<std::string>{"simPhi", "simF2w"} );
  DefineVector( sampled_d, "sim_F3", q_vector< std::vector<float>, std::vector<double> >(harmonics), std::vector<std::string>{"simPhi", "simF3w"} );
  ...
  auto p_psi_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< uvector_t, qvector_t >{}, "tru_proton", "psi_rp", std::vector{ std::pair<size_t, size_t>{1, 1} } );

  auto p_f1_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< uvector_t, qvector_t >{}, "tru_proton", "sim_F1", std::vector{ std::pair<size_t, size_t>{1, 1} } );
  auto p_f2_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< uvector_t, qvector_t >{}, "tru_proton", "sim_F2", std::vector{ std::pair<size_t, size_t>{1, 1} } );
  auto p_f3_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< uvector_t, qvector_t >{}, "tru_proton", "sim_F3", std::vector{ std::pair<size_t, size_t>{1, 1} } );
  
  auto f1_psi_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< qvector_t, qvector_t >{}, "sim_F1", "psi_rp", std::vector{ std::pair<size_t, size_t>{1, 1} } );
  auto f2_psi_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< qvector_t, qvector_t >{}, "sim_F2", "psi_rp", std::vector{ std::pair<size_t, size_t>{1, 1} } );
  auto f3_psi_names = Define2PartCorrelation( sampled_d, CorrFunc2Part< qvector_t, qvector_t >{}, "sim_F3", "psi_rp", std::vector{ std::pair<size_t, size_t>{1, 1} } );
