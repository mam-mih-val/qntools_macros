...
const auto recentering_mixing_matrix = [](const vector1d<double>& vec_c, const vector1d<double>& vec_s){
  auto c1 = vec_c[0];
  auto c2 = vec_c[1];
...
void run8_mc_proton_recenter(std::string in_file_name, std::string in_calib_file){
  ...
  tree->Branch( "F1_RECENTERED", "Qn::DataContainerQVector", &f1 );
  tree->Branch( "F2_RECENTERED", "Qn::DataContainerQVector", &f2 );
  tree->Branch( "F3_RECENTERED", "Qn::DataContainerQVector", &f3 );
  tree->Branch( "F4_RECENTERED", "Qn::DataContainerQVector", &f4 );
  tree->Branch( "Tpos_RECENTERED", "Qn::DataContainerQVector", &tp );
  tree->Branch( "Tneg_RECENTERED", "Qn::DataContainerQVector", &tn );
  tree->Branch( "proton_RECENTERED", "Qn::DataContainerQVector", &p );
