...
void run8_proton_correlations( std::string file_list, 
  ...
  handler
    .AddCorrelation( CorrelationDecorator<uvector_t, qvector_t>{ "proton", "F1", {1, 1} }, proton_weight, proton_weight)
    .AddCorrelation( CorrelationDecorator<uvector_t, qvector_t>{ "proton", "F2", {1, 1} }, proton_weight, proton_weight)
    .AddCorrelation( CorrelationDecorator<uvector_t, qvector_t>{ "proton", "F3", {1, 1} }, proton_weight, proton_weight)
    .AddCorrelation( CorrelationDecorator<uvector_t, qvector_t>{ "proton", "F4", {1, 1} }, proton_weight, proton_weight)
    
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F1", "F2", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F1", "F3", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F1", "F4", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F2", "F3", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F2", "F4", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "F3", "F4", {1, 1} }, qvector_weight, qvector_weight)
    
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tpos", "F1", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tpos", "F2", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tpos", "F3", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tpos", "F4", {1, 1} }, qvector_weight, qvector_weight)
    
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tneg", "F1", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tneg", "F2", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tneg", "F3", {1, 1} }, qvector_weight, qvector_weight)
    .AddCorrelation( CorrelationDecorator<qvector_t, qvector_t>{ "Tneg", "F4", {1, 1} }, qvector_weight, qvector_weight)
