...
void run8_mc_proton_correlations( std::string list, std::string str_effieciency_file, std::string str_calib_file ){
  ...
  DefineVector( sampled_d, "ini_F1", q_vector< ROOT::VecOps::RVec<float>, std::vector<double> >(harmonics), std::vector<std::string>{"fhcalModPhi", "F1w"} );
  DefineVector( sampled_d, "ini_F2", q_vector< ROOT::VecOps::RVec<float>, std::vector<double> >(harmonics), std::vector<std::string>{"fhcalModPhi", "F2w"} );
  DefineVector( sampled_d, "ini_F3", q_vector< ROOT::VecOps::RVec<float>, std::vector<double> >(harmonics), std::vector<std::string>{"fhcalModPhi", "F3w"} );
  ...
  sampled_d = sampled_d.Define( "F1", f1_corr_builder.IssueUVectorCorrector<qvector_t, float>(), { "ini_F1", "centrality" } );
  ...
  sampled_d = sampled_d.Define( "F2", f2_corr_builder.IssueUVectorCorrector<qvector_t, float>(), { "ini_F2", "centrality" } );
  ...
  sampled_d = sampled_d.Define( "F3", f3_corr_builder.IssueUVectorCorrector<qvector_t, float>(), { "ini_F3", "centrality" } );
  ...
  sampled_d = sampled_d.Define( "Tpos", tp_corr_builder.IssueUVectorCorrector<qvector_t, float>(), { "ini_Tpos", "centrality" } );
  ...
  sampled_d = sampled_d.Define( "Tneg", tn_corr_builder.IssueUVectorCorrector<qvector_t, float>(), { "ini_Tneg", "centrality" } );
  ...
  std::for_each( ini_p_psi_ptr.begin(), p_psi_ptr.end(), [i=0, &ini_p_psi_names]( auto& p ) mutable { p->Write( ini_p_psi_names.at(i).c_str() ); ++i; } );
