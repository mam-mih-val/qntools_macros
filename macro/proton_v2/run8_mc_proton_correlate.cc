...
void run8_mc_proton_correlate(string inputFiles="qn.root", string outputFile="corr.root")
{
  ...
  for ( auto &corr: arr_u1psiRp ){
    ...
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1x3", P2::xx(1, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1y3", P2::yy(1, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1y3", P2::xy(1, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1x3", P2::yx(1, 3), wSumWu, wy, corr, corr);

    corrBuilder.AddCorrelationWithInternalReader(corrName+".x2x3", P2::xx(2, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y2y3", P2::yy(2, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x2y3", P2::xy(2, 3), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y2x3", P2::yx(2, 3), wSumWu, wy, corr, corr);
    ...
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1x4", P2::xx(1, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1y4", P2::yy(1, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x1y4", P2::xy(1, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y1x4", P2::yx(1, 4), wSumWu, wy, corr, corr);

    corrBuilder.AddCorrelationWithInternalReader(corrName+".x2x4", P2::xx(2, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y2y4", P2::yy(2, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".x2y4", P2::xy(2, 4), wSumWu, wy, corr, corr);
    corrBuilder.AddCorrelationWithInternalReader(corrName+".y2x4", P2::yx(2, 4), wSumWu, wy, corr, corr);
  }
