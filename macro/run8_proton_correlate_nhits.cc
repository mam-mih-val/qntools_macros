...
{
  {"proton_nhits_5_RESCALED", "F1_RESCALED"},
  {"proton_nhits_5_RESCALED", "F2_RESCALED"},
  {"proton_nhits_5_RESCALED", "F3_RESCALED"},
  
  {"proton_nhits_8_RESCALED", "F1_RESCALED"},
  {"proton_nhits_8_RESCALED", "F2_RESCALED"},
  {"proton_nhits_8_RESCALED", "F3_RESCALED"},
  
  {"proton_nhits_10_RESCALED", "F1_RESCALED"},
  {"proton_nhits_10_RESCALED", "F2_RESCALED"},
  {"proton_nhits_10_RESCALED", "F3_RESCALED"},
};
...
void run8_proton_correlate_nhits(string inputFiles="qn.root", string outputFile="corr.root")
{
  int nSamples = 100;
