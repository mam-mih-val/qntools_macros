...
void run8_proton_decompose(std::string in_file_name, std::string in_calib_file){
  ...
  auto corrM_f2 = CorrectionMatrix(f2_name, in_calib_file);
  auto corrM_f3 = CorrectionMatrix(f3_name, in_calib_file);
  auto corrM_tp = CorrectionMatrix(tp_name, in_calib_file);
  auto corrM_tn = CorrectionMatrix(tn_name, in_calib_file);
  auto corrM_p = CorrectionMatrix(proton_name, in_calib_file);
