...
void run8_proton_correct_chi2( std::string list, 
  ...
  VectorConfig proton_chi2_5( "proton_chi2_5", "trPhi", "trWeight", VECTOR_TYPE::TRACK, NORMALIZATION::M );
  proton_chi2_5.SetHarmonicArray( {1, 2, 3} );
  proton_chi2_5.SetCorrections( {CORRECTION::PLAIN, CORRECTION::RECENTERING, CORRECTION::TWIST_RESCALING } );
  proton_chi2_5.SetCorrectionAxes( proton_axes );
  proton_chi2_5.AddCut( "trNsigmaProton", [](double n_sigma){
    return n_sigma < 3;
  }, "proton_chi2_5 cut" );
  proton_chi2_5.AddCut( "trFhcalX", [](double pos){
    return pos < -30.0 || pos > 160;
  }, "cut on x-pos in fhcal plane" );
  proton_chi2_5.AddCut( "trFhcalY", [](double pos){
    return pos < -60.0 || pos > 60;
  }, "cut on y-pos in fhcal plane" );
  proton_chi2_5.AddCut( "trStsNhits", [](double nhits){
    return nhits > 5.5;
  }, "cut on fake tracks" );
  proton_chi2_5.AddCut( "trDcaR", [](double dca){
    return dca < 5.0;
  }, "DCA cut" );
  proton_chi2_5.AddCut( "trStsChi2", [](double chi2){
    return chi2 < 5.0;
  }, "cut on chi2 in sts" );
  proton_chi2_5.AddHisto2D({{"trProtonY", 100, -0.5, 1.5}, {"trPt", 100, 0.0, 2.0}});
  correction_task.AddVector(proton_chi2_5);

  VectorConfig proton_chi2_4( "proton_chi2_4", "trPhi", "trWeight", VECTOR_TYPE::TRACK, NORMALIZATION::M );
  proton_chi2_4.SetHarmonicArray( {1, 2, 3} );
  proton_chi2_4.SetCorrections( {CORRECTION::PLAIN, CORRECTION::RECENTERING, CORRECTION::TWIST_RESCALING } );
  proton_chi2_4.SetCorrectionAxes( proton_axes );
  proton_chi2_4.AddCut( "trNsigmaProton", [](double n_sigma){
    return n_sigma < 3;
  }, "proton_chi2_4 cut" );
  proton_chi2_4.AddCut( "trFhcalX", [](double pos){
    return pos < -30.0 || pos > 160;
  }, "cut on x-pos in fhcal plane" );
  proton_chi2_4.AddCut( "trFhcalY", [](double pos){
    return pos < -60.0 || pos > 60;
  }, "cut on y-pos in fhcal plane" );
  proton_chi2_4.AddCut( "trStsNhits", [](double nhits){
    return nhits > 5.5;
  }, "cut on fake tracks" );
  proton_chi2_4.AddCut( "trDcaR", [](double dca){
    return dca < 5.0;
  }, "DCA cut" );
  proton_chi2_4.AddCut( "trStsChi2", [](double chi2){
    return chi2 < 4.0;
  }, "cut on chi2 in sts" );
  proton_chi2_4.AddHisto2D({{"trProtonY", 100, -0.5, 1.5}, {"trPt", 100, 0.0, 2.0}});
  correction_task.AddVector(proton_chi2_4);

  VectorConfig proton_chi2_3( "proton_chi2_3", "trPhi", "trWeight", VECTOR_TYPE::TRACK, NORMALIZATION::M );
  proton_chi2_3.SetHarmonicArray( {1, 2, 3} );
  proton_chi2_3.SetCorrections( {CORRECTION::PLAIN, CORRECTION::RECENTERING, CORRECTION::TWIST_RESCALING } );
  proton_chi2_3.SetCorrectionAxes( proton_axes );
  proton_chi2_3.AddCut( "trNsigmaProton", [](double n_sigma){
    return n_sigma < 3;
  }, "proton_chi2_3 cut" );
  proton_chi2_3.AddCut( "trFhcalX", [](double pos){
    return pos < -30.0 || pos > 160;
  }, "cut on x-pos in fhcal plane" );
  proton_chi2_3.AddCut( "trFhcalY", [](double pos){
    return pos < -60.0 || pos > 60;
  }, "cut on y-pos in fhcal plane" );
  proton_chi2_3.AddCut( "trStsNhits", [](double nhits){
    return nhits > 5.5;
  }, "cut on fake tracks" );
  proton_chi2_3.AddCut( "trDcaR", [](double dca){
    return dca < 5.0;
  }, "DCA cut" );
  proton_chi2_3.AddCut( "trStsChi2", [](double chi2){
    return chi2 < 3.0;
  }, "cut on chi2 in sts" );
  proton_chi2_3.AddHisto2D({{"trProtonY", 100, -0.5, 1.5}, {"trPt", 100, 0.0, 2.0}});
  correction_task.AddVector(proton_chi2_3);
